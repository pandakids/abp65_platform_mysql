...
import {TempleMembersServiceProxy, TempleLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class TempleLookupTableModalComponent extends AppComponentBase{
    ...
    getAll(event?: LazyLoadEvent) {
		...
		this._templeMembersServiceProxy.getAllTempleForLookupTable(
			this.filterText,
