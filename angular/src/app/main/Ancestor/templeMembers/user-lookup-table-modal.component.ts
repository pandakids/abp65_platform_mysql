...
import {TempleMembersServiceProxy, UserLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class UserLookupTableModalComponent extends AppComponentBase{
    ...
    getAll(event?: LazyLoadEvent) {
		...
		this._templeMembersServiceProxy.getAllUserForLookupTable(
			this.filterText,
