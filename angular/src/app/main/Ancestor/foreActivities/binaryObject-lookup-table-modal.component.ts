...
import {ForeActivitiesServiceProxy, BinaryObjectLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class BinaryObjectLookupTableModalComponent extends AppComponentBase{
    ...
    getAll(event?: LazyLoadEvent) {
		...
		this._foreActivitiesServiceProxy.getAllBinaryObjectForLookupTable(
			this.filterText,
