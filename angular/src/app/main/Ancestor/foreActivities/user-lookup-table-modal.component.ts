...
import {ForeActivitiesServiceProxy, UserLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class UserLookupTableModalComponent extends AppComponentBase{
    ...
    getAll(event?: LazyLoadEvent) {
		...
		this._foreActivitiesServiceProxy.getAllUserForLookupTable(
			this.filterText,
