...
import {ForeFathersServiceProxy, TempleLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class TempleLookupTableModalComponent extends AppComponentBase{
    ...
    getAll(event?: LazyLoadEvent) {
		...
		this._foreFathersServiceProxy.getAllTempleForLookupTable(
			this.filterText,
