...
namespace Hoooten.PlatformMysql.Tests.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<PlatformMysqlDbContext>>()
                    .Instance(builder.Options)
                    .LifestyleSingleton()
            );

            inMemorySqlite.Open();
            new PlatformMysqlDbContext(builder.Options).Database.EnsureCreated();
        }
