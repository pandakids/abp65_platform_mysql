...
using MvvmHelpers;
using Hoooten.PlatformMysql.Authorization.Users.Profile;
using Hoooten.PlatformMysql.Authorization.Users.Profile.Dto;
using Hoooten.PlatformMysql.Commands;
...
using Hoooten.PlatformMysql.Controls;
using Hoooten.PlatformMysql.Dto;
using Hoooten.PlatformMysql.Extensions;
using Hoooten.PlatformMysql.Localization;
using Hoooten.PlatformMysql.UI;
using Hoooten.PlatformMysql.UI.Assets;
using Hoooten.PlatformMysql.Views;
using DependencyResolver = Hoooten.PlatformMysql.Core.Dependency.DependencyResolver;
...
namespace Hoooten.PlatformMysql.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PlatformMysql";
