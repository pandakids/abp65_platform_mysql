...
using Hoooten.PlatformMysql.Web.Public.Startup;
using Hoooten.PlatformMysql.Web.Session;

namespace Hoooten.PlatformMysql.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PlatformMysqlViewComponent
    {
