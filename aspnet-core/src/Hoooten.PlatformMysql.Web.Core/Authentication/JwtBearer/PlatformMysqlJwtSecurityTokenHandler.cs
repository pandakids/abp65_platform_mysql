...
namespace Hoooten.PlatformMysql.Web.Authentication.JwtBearer
{
    public class PlatformMysqlJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public PlatformMysqlJwtSecurityTokenHandler()
        {
