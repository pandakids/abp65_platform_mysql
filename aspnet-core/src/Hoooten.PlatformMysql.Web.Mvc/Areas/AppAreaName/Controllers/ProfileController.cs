...
using Hoooten.PlatformMysql.Timing.Dto;
using Hoooten.PlatformMysql.Web.Areas.AppAreaName.Models.Profile;
...
namespace Hoooten.PlatformMysql.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class ProfileController : PlatformMysqlControllerBase
    {
