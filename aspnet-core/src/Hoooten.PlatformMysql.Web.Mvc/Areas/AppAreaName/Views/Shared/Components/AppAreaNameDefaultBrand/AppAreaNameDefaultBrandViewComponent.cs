...
namespace Hoooten.PlatformMysql.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameDefaultBrand
{
    public class AppAreaNameDefaultBrandViewComponent : PlatformMysqlViewComponent
    {
