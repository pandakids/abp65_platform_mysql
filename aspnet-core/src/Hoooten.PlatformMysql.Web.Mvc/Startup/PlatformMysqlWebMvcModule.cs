...
namespace Hoooten.PlatformMysql.Web.Startup
{
    ...
    public class PlatformMysqlWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PlatformMysqlWebMvcModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PlatformMysqlWebMvcModule).GetAssembly());
        }
