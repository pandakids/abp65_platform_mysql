...
using Hoooten.PlatformMysql.Authorization.Accounts;
using Hoooten.PlatformMysql.Authorization.Accounts.Dto;
using Hoooten.PlatformMysql.Authorization.Impersonation;
...
using Hoooten.PlatformMysql.Web.Models.Account;
...
using Hoooten.PlatformMysql.Web.Security.Recaptcha;
using Hoooten.PlatformMysql.Web.Session;
using Hoooten.PlatformMysql.Web.Views.Shared.Components.TenantChange;

namespace Hoooten.PlatformMysql.Web.Controllers
{
    public class AccountController : PlatformMysqlControllerBase
    {
