...
<div class="search-plus" id="book-search-results">
    <div class="search-noresults">
                                ...
                                <h1 id="accessible-charts">Accessible Charts</h1>
<p>Chart.js charts are rendered on user provided <code>canvas</code> elements. Thus, it is up to the user to create the <code>canvas</code> element in a way that is accessible. The <code>canvas</code> element has support in all browsers and will render on screen but the <code>canvas</code> content will not be accessible to screen readers.</p>
<p>With <code>canvas</code>, the accessibility has to be added with <code>ARIA</code> attributes on the <code>canvas</code> element or added using internal fallback content placed within the opening and closing canvas tags.</p>
<p>This <a href="http://pauljadam.com/demos/canvas.html" target="_blank">website</a> has a more detailed explanation of <code>canvas</code> accessibility as well as in depth examples.</p>
<h2 id="examples">Examples</h2>
<p>These are some examples of <strong>accessible</strong> <code>canvas</code> elements.</p>
<p>By setting the <code>role</code> and <code>aria-label</code>, this <code>canvas</code> now has an accessible name.</p>
<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">canvas</span> <span class="hljs-attr">id</span>=<span class="hljs-string">&quot;goodCanvas1&quot;</span> <span class="hljs-attr">width</span>=<span class="hljs-string">&quot;400&quot;</span> <span class="hljs-attr">height</span>=<span class="hljs-string">&quot;100&quot;</span> <span class="hljs-attr">aria-label</span>=<span class="hljs-string">&quot;Hello ARIA World&quot;</span> <span class="hljs-attr">role</span>=<span class="hljs-string">&quot;img&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">canvas</span>&gt;</span>
</code></pre>
<p>This <code>canvas</code> element has a text alternative via fallback content.</p>
<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">canvas</span> <span class="hljs-attr">id</span>=<span class="hljs-string">&quot;okCanvas2&quot;</span> <span class="hljs-attr">width</span>=<span class="hljs-string">&quot;400&quot;</span> <span class="hljs-attr">height</span>=<span class="hljs-string">&quot;100&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Hello Fallback World<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">canvas</span>&gt;</span>
</code></pre>
<p>These are some bad examples of <strong>inaccessible</strong> <code>canvas</code> elements.</p>
<p>This <code>canvas</code> element does not have an accessible name or role.</p>
<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">canvas</span> <span class="hljs-attr">id</span>=<span class="hljs-string">&quot;badCanvas1&quot;</span> <span class="hljs-attr">width</span>=<span class="hljs-string">&quot;400&quot;</span> <span class="hljs-attr">height</span>=<span class="hljs-string">&quot;100&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">canvas</span>&gt;</span>
</code></pre>
<p>This <code>canvas</code> element has inaccessible fallback content.</p>
<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">canvas</span> <span class="hljs-attr">id</span>=<span class="hljs-string">&quot;badCanvas2&quot;</span> <span class="hljs-attr">width</span>=<span class="hljs-string">&quot;400&quot;</span> <span class="hljs-attr">height</span>=<span class="hljs-string">&quot;100&quot;</span>&gt;</span>Your browser does not support the canvas element.<span class="hljs-tag">&lt;/<span class="hljs-name">canvas</span>&gt;</span>
</code></pre>
