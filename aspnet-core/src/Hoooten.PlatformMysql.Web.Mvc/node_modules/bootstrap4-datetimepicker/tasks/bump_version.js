module.exports = function(grunt) {
  grunt.registerTask('bump_version', function(version) {
    ...
    grunt.config('string-replace.bootstrap-datetimepicker-css', {
      files: {
        'src/less/_bootstrap-datetimepicker.less': 'src/less/_bootstrap-datetimepicker.less',
        'src/scss/_bootstrap-datetimepicker.scss': 'src/scss/_bootstrap-datetimepicker.scss'
      },
      options: {
        replacements: [{
          pattern: / * version : .*/,
