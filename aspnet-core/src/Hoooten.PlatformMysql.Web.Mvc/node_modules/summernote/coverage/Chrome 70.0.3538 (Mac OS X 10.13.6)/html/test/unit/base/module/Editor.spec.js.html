  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>230/236</span>
      </div>
      <div class='fl pad1y space-right2'>
...
437
438
439</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  describe('indent and outdent', () =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (env.isPhantom) {
<span class="cstat-no" title="statement not covered" >      it('should indent and outdent paragraph', <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        editor.indent();</span>
<span class="cstat-no" title="statement not covered" >        expectContents(context, '&lt;p style="margin-left: 25px;"&gt;hello&lt;/p&gt;');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        editor.outdent();</span>
<span class="cstat-no" title="statement not covered" >        expectContents(context, '&lt;p style=""&gt;hello&lt;/p&gt;');</span>
      });
    }
&nbsp;
