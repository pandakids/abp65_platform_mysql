...
238
239
240</td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >const toolbar = renderer.create('&lt;div class="note-toolbar card-header" role="toolbar"&gt;&lt;/div&gt;');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >const checkbox = renderer.create('&lt;div class="custom-control custom-checkbox"&gt;&lt;/div&gt;', <span class="fstat-no" title="function not covered" >function($node, options)</span> {</span>
<span class="cstat-no" title="statement not covered" >  $node.html([</span>
