...
<span class="cline-any cline-yes">1338×</span>
<span class="cline-any cline-yes">1338×</span>
<span class="cline-any cline-yes">1338×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">122×</span>
...
<span class="cline-any cline-yes">2196×</span>
<span class="cline-any cline-yes">2196×</span>
<span class="cline-any cline-yes">17568×</span>
<span class="cline-any cline-yes">17568×</span>
<span class="cline-any cline-yes">17568×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">5096×</span>
<span class="cline-any cline-yes">5096×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
const checkbox = renderer.create('&lt;div class="checkbox"&gt;&lt;/div&gt;', function($node, options) {
  $node.html([
    '&lt;label' + (options.id ? <span class="branch-0 cbranch-no" title="branch not covered" >' for="' + options.id + '"' </span>: '') + '&gt;',
    ' &lt;input role="checkbox" type="checkbox"' + (options.id ? <span class="branch-0 cbranch-no" title="branch not covered" >' id="' + options.id + '"' </span>: ''),
    ...
    return renderer.create('&lt;button type="button" class="note-btn btn btn-default btn-sm" role="button" tabindex="-1"&gt;', function($node, options) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (options &amp;&amp; options.tooltip) {
        $node.attr({
          ...
          container: (options.container !== undefined) ? options.container : <span class="branch-1 cbranch-no" title="branch not covered" >'body',</span>
          trigger: 'hover',
          placement: 'bottom'
        });
      }
