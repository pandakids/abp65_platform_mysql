...
638
639
640</td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >          let value = $button.data('value');</span>
<span class="cstat-no" title="statement not covered" >          const foreinput = document.getElementById('html5fcp').value;</span>
<span class="cstat-no" title="statement not covered" >          const backinput = document.getElementById('html5bcp').value;</span>
<span class="cstat-no" title="statement not covered" >          if (value === 'cp') {</span>
<span class="cstat-no" title="statement not covered" >            event.stopPropagation();</span>
          } else <span class="cstat-no" title="statement not covered" >if (value === 'cpbackColor') {</span>
<span class="cstat-no" title="statement not covered" >            value = backinput;</span>
          } else <span class="cstat-no" title="statement not covered" >if (value === 'cpforeColor') {</span>
<span class="cstat-no" title="statement not covered" >            value = foreinput;</span>
          }
&nbsp;
