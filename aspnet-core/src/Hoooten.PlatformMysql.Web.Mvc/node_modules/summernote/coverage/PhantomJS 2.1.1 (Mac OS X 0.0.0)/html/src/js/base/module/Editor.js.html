  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">73.25% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>293/400</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">47.49% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>85/179</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">66.67% </span>
        <span class="quiet">Functions</span>
        <span class='fraction'>56/84</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">73.92% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>292/395</span>
      </div>
    </div>
  </div>
...
861
862
863</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
  ...
  saveRange(thenCollapse) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (thenCollapse) {
...
&nbsp;
  ...
  * commit
  */
<span class="fstat-no" title="function not covered" >  commit() {</span>
<span class="cstat-no" title="statement not covered" >    this.context.triggerEvent('before.command', this.$editable.html());</span>
<span class="cstat-no" title="statement not covered" >    this.history.commit();</span>
<span class="cstat-no" title="statement not covered" >    this.context.triggerEvent('change', this.$editable.html());</span>
  }
&nbsp;
  /**
   * redo
...
&nbsp;
   ...
   * @param {File[]} files
   */
<span class="fstat-no" title="function not covered" >  insertImagesAsDataURL(files)</span> {
...
&nbsp;
    ...
    const linkInfo = {
      range: rng,
      text: rng.toString(),
      url: $anchor.length ? $anchor.attr('href') : <span class="branch-1 cbranch-no" title="branch not covered" >''</span>
    };
&nbsp;
    // When anchor exists,
    <span class="missing-if-branch" title="else path not taken" >E</span>if ($anchor.length) {
