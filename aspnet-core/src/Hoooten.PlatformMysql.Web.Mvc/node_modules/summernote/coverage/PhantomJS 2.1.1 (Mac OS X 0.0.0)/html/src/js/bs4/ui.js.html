...
&nbsp;
<span class="cstat-no" title="statement not covered" >const checkbox = renderer.create('&lt;div class="form-check"&gt;&lt;/div&gt;', <span class="fstat-no" title="function not covered" >function($node, options)</span> {</span>
<span class="cstat-no" title="statement not covered" >  $node.html([</span>
