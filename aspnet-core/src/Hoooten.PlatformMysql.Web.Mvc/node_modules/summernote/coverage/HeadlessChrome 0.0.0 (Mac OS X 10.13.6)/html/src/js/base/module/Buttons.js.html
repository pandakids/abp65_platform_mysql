  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>233/277</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">55.17% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>48/87</span>
      </div>
      <div class='fl pad1y space-right2'>
...
897
898
899</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">3749×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3749×</span>
<span class="cline-any cline-yes">3749×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">891×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
      ...
      children: [
        this.button({
          ...
          click: (e) =&gt; {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (backColor &amp;&amp; foreColor) {
              this.context.invoke('editor.color', {
                backColor: $button.attr('data-backColor'),
                foreColor: $button.attr('data-foreColor')
              });
            } else <span class="cstat-no" title="statement not covered" >if (backColor) {</span>
<span class="cstat-no" title="statement not covered" >              this.context.invoke('editor.color', {</span>
                backColor: $button.attr('data-backColor')
              });
            } else <span class="cstat-no" title="statement not covered" >if (foreColor) {</span>
<span class="cstat-no" title="statement not covered" >              this.context.invoke('editor.color', {</span>
                foreColor: $button.attr('data-foreColor')
              });
            }
        ...
        this.ui.dropdown({
          ...
          callback: ($dropdown) =&gt; {
            ...
            $dropdown.find('input[type=color]').each((idx, item) =&gt; {
              $(item).change(<span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >                const $chip = $dropdown.find('#' + $(this).data('event')).find('.note-color-btn').first();</span>
<span class="cstat-no" title="statement not covered" >                const color = this.value.toUpperCase();</span>
<span class="cstat-no" title="statement not covered" >                $chip.css('background-color', color)</span>
                  .attr('aria-label', color)
                  .attr('data-value', color)
                  .attr('data-original-title', color);
<span class="cstat-no" title="statement not covered" >                $chip.click();</span>
              });
            });
          },
          click: (event) =&gt; {
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (eventName === 'openPalette') {
<span class="cstat-no" title="statement not covered" >              const $picker = $parent.find('#' + value);</span>
<span class="cstat-no" title="statement not covered" >              const $palette = $($parent.find('#' + $picker.data('event')).find('.note-color-row')[0]);</span>
&nbsp;
              // Shift palette chips
<span class="cstat-no" title="statement not covered" >              const $chip = $palette.find('.note-color-btn').last().detach();</span>
&nbsp;
              // Set chip attributes
<span class="cstat-no" title="statement not covered" >              const color = $picker.val();</span>
<span class="cstat-no" title="statement not covered" >              $chip.css('background-color', color)</span>
                .attr('aria-label', color)
                .attr('data-value', color)
                .attr('data-original-title', color);
<span class="cstat-no" title="statement not covered" >              $palette.prepend($chip);</span>
<span class="cstat-no" title="statement not covered" >              $picker.click();</span>
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (lists.contains(['backColor', 'foreColor'], eventName)) {
...
&nbsp;
      ...
      $.each(styleInfo['font-family'].split(','), (idx, fontname) =&gt; {
        ...
        if (this.isFontDeservedToAdd(fontname)) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if ($.inArray(fontname, this.options.fontNames) === -1) {
<span class="cstat-no" title="statement not covered" >            this.options.fontNames.push(fontname);</span>
          }
        }
      });
&nbsp;
