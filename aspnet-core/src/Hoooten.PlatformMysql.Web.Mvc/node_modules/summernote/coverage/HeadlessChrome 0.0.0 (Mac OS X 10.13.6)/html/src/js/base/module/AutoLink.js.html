...
<span class="cstat-no" title="statement not covered" >      if (this.context.options.linkTargetBlank) {</span>
<span class="cstat-no" title="statement not covered" >        $(node).attr('target', '_blank');</span>
      }
&nbsp;
