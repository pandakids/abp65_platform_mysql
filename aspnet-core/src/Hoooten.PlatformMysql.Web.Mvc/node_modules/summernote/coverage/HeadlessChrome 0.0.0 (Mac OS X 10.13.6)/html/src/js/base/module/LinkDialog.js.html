  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>54/76</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  bindEnterKey($input, $btn) {
    $input.on('keypress', <span class="fstat-no" title="function not covered" >(event)</span> =&gt; {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!linkInfo.url) {
<span class="cstat-no" title="statement not covered" >          linkInfo.url = linkInfo.text;</span>
        }
&nbsp;
        $linkText.val(linkInfo.text);
&nbsp;
        const handleLinkTextUpdate = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
&nbsp;
        $linkText.on('input', handleLinkTextUpdate).on('paste', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          setTimeout(handleLinkTextUpdate, 0);</span>
        });
&nbsp;
        const handleLinkUrlUpdate = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.toggleLinkBtn($linkBtn, $linkText, $linkUrl);</span>
...
&nbsp;
        $linkUrl.on('input', handleLinkUrlUpdate).on('paste', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          setTimeout(handleLinkUrlUpdate, 0);</span>
        }).val(linkInfo.url);
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!env.isSupportTouch) {
...
&nbsp;
        const isNewWindowChecked = linkInfo.isNewWindow !== undefined
          ? linkInfo.isNewWindow : <span class="branch-1 cbranch-no" title="branch not covered" >this.context.options.linkTargetBlank;</span>
&nbsp;
        $openInNewWindow.prop('checked', isNewWindowChecked);
&nbsp;
        $linkBtn.one('click', <span class="fstat-no" title="function not covered" >(event)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >          event.preventDefault();</span>
&nbsp;
...
&nbsp;
      this.ui.onDialogHidden(this.$dialog, <span class="fstat-no" title="function not covered" >() =&gt; {</span>
        // detach events
...
&nbsp;
    ...
    this.showLinkDialog(linkInfo).then(<span class="fstat-no" title="function not covered" >(linkInfo)</span> =&gt; {
