...
<span class="cstat-no" title="statement not covered" >        if (this.options.callbacks.onImageLinkInsert) {</span>
<span class="cstat-no" title="statement not covered" >          this.context.triggerEvent('image.link.insert', data);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          this.context.invoke('editor.insertImage', data);</span>
        }
      } else { // array of files
        // If onImageUpload set,
<span class="cstat-no" title="statement not covered" >        if (this.options.callbacks.onImageUpload) {</span>
<span class="cstat-no" title="statement not covered" >          this.context.triggerEvent('image.upload', data);</span>
        } else {
          // else insert Image as dataURL
<span class="cstat-no" title="statement not covered" >          this.context.invoke('editor.insertImagesAsDataURL', data);</span>
        }
      }
