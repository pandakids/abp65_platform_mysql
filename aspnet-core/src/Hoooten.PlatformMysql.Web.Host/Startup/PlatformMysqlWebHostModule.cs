...
namespace Hoooten.PlatformMysql.Web.Startup
{
    ...
    public class PlatformMysqlWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PlatformMysqlWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PlatformMysqlWebHostModule).GetAssembly());
        }
