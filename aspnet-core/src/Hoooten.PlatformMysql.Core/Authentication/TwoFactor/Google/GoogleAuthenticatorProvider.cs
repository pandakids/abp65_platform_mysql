...
namespace Hoooten.PlatformMysql.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PlatformMysqlServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Hoooten.PlatformMysql", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
