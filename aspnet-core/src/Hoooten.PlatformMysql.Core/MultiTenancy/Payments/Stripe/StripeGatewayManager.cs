...
{
    public class StripeGatewayManager : PlatformMysqlServiceBase, ISupportsRecurringPayments, ITransientDependency
    {
        private readonly TenantManager _tenantManager;
        private readonly EditionManager _editionManager;
        private readonly ISubscriptionPaymentRepository _subscriptionPaymentRepository;

        public static string ProductName = "PlatformMysql";
        ...
        public async Task<StripeIdResponse> CreateCharge(string source, decimal amount, string description)
        {
            ...
            var charge = await chargeService.CreateAsync(new ChargeCreateOptions
            {
                ...
                Currency = PlatformMysqlConsts.Currency,
                Capture = true
            });
