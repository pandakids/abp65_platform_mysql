...
using Hoooten.PlatformMysql.MultiTenancy.Demo;
...
namespace Hoooten.PlatformMysql.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(PlatformMysqlConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
