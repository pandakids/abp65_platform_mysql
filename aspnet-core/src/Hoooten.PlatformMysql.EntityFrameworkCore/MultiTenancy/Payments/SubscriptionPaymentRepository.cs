...
using Hoooten.PlatformMysql.EntityFrameworkCore.Repositories;

namespace Hoooten.PlatformMysql.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : PlatformMysqlRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PlatformMysqlDbContext> dbContextProvider)
