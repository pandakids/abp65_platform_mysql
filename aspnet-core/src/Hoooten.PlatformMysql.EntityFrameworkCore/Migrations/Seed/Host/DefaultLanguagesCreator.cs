...
namespace Hoooten.PlatformMysql.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PlatformMysqlConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(PlatformMysqlDbContext context)
        {
            _context = context;
        }
