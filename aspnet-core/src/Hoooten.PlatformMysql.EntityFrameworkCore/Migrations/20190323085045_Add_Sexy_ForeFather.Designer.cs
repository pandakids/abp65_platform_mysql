...
namespace Hoooten.PlatformMysql.Migrations
{
    ...
    [Migration("20190323085045_Add_Sexy_ForeFather")]
    partial class Add_Sexy_ForeFather
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("admin_area")
                        .IsRequired()
                        .HasMaxLength(10);
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.ForeActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ForeActivities");
                });

            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.ForeFather", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime?>("DieAt");

                    b.Property<int>("FlowersNumber");

                    b.Property<int>("GoldNumber");
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.ForeFatherGift", b =>
                {
                    ...
                    b.Property<int>("TheGiftType");

                    b.Property<long?>("UserId");

                    b.HasKey("Id");

                    b.HasIndex("ForeFatherId");

                    b.HasIndex("UserId");

                    b.ToTable("ForeFatherGifts");
                });

            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.Temple", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.TempleMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TempleMembers");
                });

            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.UserGift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.MultiTenancy.Accounting.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.MultiTenancy.Payments.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Editions.SubscribableEdition", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Hoooten.PlatformMysql.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Hoooten.PlatformMysql.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Ancestor.ForeFatherGift", b =>
                {
                    b.HasOne("Hoooten.PlatformMysql.Ancestor.ForeFather", "ForeFather")
                        .WithMany()
                        .HasForeignKey("ForeFatherId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Hoooten.PlatformMysql.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Hoooten.PlatformMysql.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Hoooten.PlatformMysql.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Hoooten.PlatformMysql.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
