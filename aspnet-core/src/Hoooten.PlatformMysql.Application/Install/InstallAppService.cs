...
using Hoooten.PlatformMysql.Migrations.Seed.Host;
...
namespace Hoooten.PlatformMysql.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PlatformMysqlAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PlatformMysqlDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(PlatformMysqlConsts.ConnectionStringName).Value.ToString();
        }
